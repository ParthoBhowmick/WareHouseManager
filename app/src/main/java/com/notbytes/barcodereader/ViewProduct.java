...
public class ViewProduct extends AppCompatActivity implements BarcodeReaderFragment.BarcodeReaderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        flashBuilder.setMessage("Want to use Flash?");
    ...
    public void  success() {
        String intentData = "https://www.jadroo.com/" + product_name;
    ...
    public class Background extends AsyncTask<String, Void,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.contains("found+")) {
                int len = s.length();
                product_name = s.substring(6,len);
                success();
            }
